...
<html lang="en">
	<head>
		...
		<?php 
			...
			$result = FLogs::getLogs();
	
			if(!$result) {
				$errorMessage = "LOGS CANNOT BE LISTED!";
			}
		?>
	</head>
					...
					<div class="row-fluid">
						...
						<table id="sample-table-2" class="table table-striped table-bordered table-hover">
							...
							<tbody>
									...
									{
										echo "<tr>";
										echo "<td><a href='user-profile.php?id=".$logs[$i]->user->userID."'>".$logs[$i]->user->userName."</a></td>";
										echo "<td>".$logs[$i]->productID."</td>";
										echo "<td>".$logs[$i]->action."</td>";
										echo "<td>".$logs[$i]->date."</td>
